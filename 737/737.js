...
// words2 = ["fine", "drama", "talent"] are similar, if the similar 
// word pairs are pairs = [["great", "good"], ["fine", "good"], ["acting","drama"], 
// ["skills","talent"]].

// Note that the similarity relation is transitive. For example, 
// if "great" and "good" are similar, and "fine" and "good" are similar, then 
